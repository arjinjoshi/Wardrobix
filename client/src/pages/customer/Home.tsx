...
const bannerMainCardClass =
  "group h-[535px] w-full relative overflow-hidden rounded-[2rem] border border-border/30 bg-card shadow-xl transition-all duration-500 hover:shadow-2xl hover:shadow-primary/5";
...
const bannerSideCardClass =
  "group h-[258px] w-full overflow-hidden rounded-[2rem] border border-border/40 bg-card shadow-lg transition-all duration-500 hover:-translate-y-1 hover:shadow-xl hover:shadow-primary/5";
...
export function StoreHome() {
  ...
  const sideBanners = Array.isArray(data.banners) ? data.banners.slice(1, 3) : [];
  ...
  <div className={bannerGridClass}>
    ...
    <Card className={bannerMainCardClass}>
      {mainBanner?.imageUrl ? (
        ...
        <div className="h-[540px] w-full flex items-center justify-center bg-muted/50 rounded-[2rem]">
    ...
    <div className={bannerSideGridClass}>
      {sideBanners.length > 0 ? (
        ...
        <Card className={bannerSideCardClass}>
          <div className="h-64.5 w-full flex items-center justify-center bg-muted/50 rounded-[2rem]">
            <p className="text-muted-foreground text-sm">No banners</p>
          </div>
        </Card>
      )}
    </div>
